...
const backUp = JSON.parse(
  window.localStorage.getItem("cotizacion.data")! ??
    `${JSON.stringify({
...
watch(data, (value) => {
  window.localStorage.setItem("cotizacion.data", JSON.stringify(value));
});
...
const formatDOP = (value: number, currency = "DOP") => {
    ...
    <div class="flex flex-col md:flex-row md:space-x-3">
        ...
        <Tab.Group>
          ...
          <Tab.Panels>
            <Tab.Panel class="mt-10 space-y-4">
              ...
              <div>
                <FormLabel htmlFor="Cotizadó-a">Cotizadó a:</FormLabel>
                <FormInput
                  placeholder="Cotizadó a"
            ...
            <Tab.Panel class="mt-10 space-y-4">
              ...
              <div>
                <FormLabel htmlFor="dolar">Precio Dolar:</FormLabel>
                <FormInput
                  v-model="currentItem.dolar"
      ...
      >
        ...
        <div class="w-full mt-5 px-10">
          <h1 class="text-2xl font-bold mb-5">COTIZACIÓN</h1>
        </div>
          ...
          <Table.Tbody>
            <Table.Tr v-for="(prod, index) in [...items]" :key="index">
              ...
              <Table.Td>
                {{
                  formatDOP(
                    (prod.cantidad * prod.precio) / currentItem.dolar,
                    "USD"
                  )
                }}
              </Table.Td>
        ...
        <div class="flex flex-row w-full px-10 justify-between mt-5">
          <div class="flex flex-col">
            ...
            <span
              class="font-semibold max-w-[400px] break-words whitespace-pre-wrap mt-10"
            >
              Importante:
              <span class="font-normal break-words whitespace-pre-wrap">
